...
export const ViewAllReference = () => {
  ...
  const columns =
    [
      ...
      },
      {
        ...
        sortable: true,
        cell: (cells) => <p className={`${cells.type === 'Buy' ? 'text-textBuyGreen bg-bgBuyGreen' : 'text-textSellRed bg-bgSellRed'} px-3 py-1 rounded`}>{cells.type}</p>
      },
      {
        name: "Stock Name",
  ...
  return (
    <div className="flex flex-[0.85] flex-col overflow-auto">
      <ModuleHeader module={"Manage Tips"} subModule={"View All Reference"} />
